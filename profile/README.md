...
|---------|--------------|-------|
| **[Custom Mail](https://github.com/InnoNestX/Custom-Mail)** | Private web mail console on Cloudflare Workers. Markdown compose, attachments, preview, send history — outbound via Brevo | [Demo](https://mail.xuxuclassmate.com) · [Docs](https://innonestx.github.io/Custom-Mail/) · [Repo](https://github.com/InnoNestX/Custom-Mail) |
...
| **[GlobalPulse](https://github.com/InnoNestX/GlobalPulse)** | Self-hosted market briefing bot on Cloudflare Workers. A-share / US stock / crypto / hotspot digests → Feishu, WeChat, Telegram, Email (plus Discord / Slack) | [Docs](https://innonestx.github.io/GlobalPulse/) · [Repo](https://github.com/InnoNestX/GlobalPulse) |
